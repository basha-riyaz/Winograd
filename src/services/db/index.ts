...
export const dbService = {
  ...
  //manasa-s
  getLatestTestRun: agentConfigService.getLatestTestRun.bind(agentConfigService),
  updateAgentStatus: agentConfigService.updateAgentStatus.bind(agentConfigService),
  //manasa-e
  // Persona
  ...
  getUniqueTestRun: testRunService.getUniqueTestRun.bind(testRunService),
  ...
  getAgentHealthData : conversationService.getAgentHealthData.bind(conversationService),
};