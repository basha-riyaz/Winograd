                ...
                {runs?.map((run) => {
                  ...
                  return (
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center">
                          <div className="w-full max-w-[100px]">
                            ...
                            <div className="w-full bg-secondary rounded-full h-2">
                              <div
                                className={`h-2 rounded-full transition-all ${successRate >= 80 ? 'bg-green-600' :
                      ...
                      <TableCell className="pointer-events-none opacity-0 select-none">
                        <Button
                          size="sm"
                          variant="ghost"
                          onClick={(e) => {
                            e.stopPropagation();
                            toast({ title: "Success", description: 'test deleted ', duration : 5000 ,variant: "warning" });
                            console.log("success");
                          }}
                        >
